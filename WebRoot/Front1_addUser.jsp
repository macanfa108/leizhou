...
<div class="content">
  ...
  <div class="mainbar">
            ...
            <br/>  
            <br/>  
                <form align="center" align="right" class="form-search s-widget" name="form" method="post" action="UserServlet?method=1&sign=1" onSubmit="return accountADD()">
              <div class="input-append">
                                         登&nbsp;录&nbsp;名&nbsp;
               <input type="text"  id="inputPassword" placeholder="登录名" style="height:31px;width:200px" name="account">
                
               <br/>                        
              <br/>
                            
                                           真实姓名
               <input type="text"  id="inputPassword" placeholder="真实名" style="height:31px;width:200px" name="realName">
                
               <br/>                        
              <br/>
               
                                          手&nbsp;&nbsp;机号   &nbsp;                           
               <input type="text"  id="inputPassword" placeholder="手机号" style="height:31px;width:200px" name="telNumber">
                
               <br/>                        
              <br/> 
              
                                           密&nbsp;&nbsp;码  &nbsp;&nbsp;                                  
               <input type="password"  id="inputPassword" placeholder="密码" style="height:31px;width:200px" name="password">
              <br/>                        
              <br/>  
                                        
                                            重复密码
               <input type="password"  id="inputPassword" placeholder="重复密码" style="height:31px;width:200px" name="repeatPassword">
