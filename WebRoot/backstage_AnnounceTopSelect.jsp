...
<div class="box-body">
				...
				<span style="width:100px;height:50px;bgcolor:yellow;float:left;"font-size:16pt><h1>公告列表</h1></span>
              <div class="input-append">
              
                <input type="text"  id="inputPassword" placeholder="请输入公告名" style="height:31px;width:200px" name="discussName">
           ...
           <table class="table table-hover table-responsive">
            <tr >
              <td width="300" >话题标题</td>
              <td width="225" >话题内容</td>
     ...
     <%for(int i=0;i<list.size();i++){ 
         ...
         %> 
        <%--  <tr  bgcolor="#009393">
              <td height="45" bgcolor="#009393" ><div align="left" ><%=discussForm.getAnnounceTitle()%></div></td>
              <td><div align="center"><%=content%></div></td>
              <td title="如果想察看详细内容，单击相应的修改链接"bgcolor="#009393"><div align="center"><%=discussForm.getAnnounceTime()%></div></td>
             <td><div align="center"><%=discussForm.getAnnounceStatus()%></div></td>
             <!--   
           ...
           -->
              <td><div align="center" bgcolor="#009393"><a href="backstage_AnnounceTopSelect.jsp?id=<%=discussForm.getAnnounceId()%>" title="可以查看相应的公告内容">置顶</a>&nbsp;&nbsp;<a href="javascript:deleteForm('<%=discussForm.getAnnounceId()%>')">删除</a></div></td>
            </tr> --%>
            <tr >
              <td><%=discussForm.getAnnounceTitle()%></td>
              <td><%=content%></td>
              <td title="如果想察看详细内容，单击相应的修改链接"><%=discussForm.getAnnounceTime()%></td>
              <td><%=discussForm.getAnnounceStatus()%></td>
             <!--   
             <td><div align="center" bgcolor="#009393"><a href="javascript:deleteForm('<%=discussForm.getAnnounceId()%>')" title="可以查看相应的公告内容">置顶</a>&nbsp;&nbsp;<a href="javascript:deleteForm('<%=discussForm.getAnnounceId()%>')">删除</a></div></td>
           -->
              <td>
