...
<div class="content">
  ...
  <div class="mainbar container">
                ...
                <form  align="center" class="form-search s-widget" name="form" method="post" action="DiscussServlet?method=0" onSubmit="return userCheck()"">
              <h1>添加公告</h1>
              <div class="input-append">
                                           公告标题&nbsp;&nbsp;
               <input type="text"   id="inputPassword" placeholder="请输入公告标题" style="height:31px;width:500px" name="discussTitle">
                
               <br/>                        
              <br/>  
              <br/>                            
               公告内容&nbsp;&nbsp;                             
               <textarea  id="inputPassword" placeholder="请输入公告内容" cols="80" rows="15" style="width:500px" name="discussContent" ></textarea>
              <br/>                        
              <br/>  
              <br/>                            
                                        发布时间&nbsp;&nbsp;
               <input type="text"  id="inputPassword" placeholder="" style="height:31px;width:500px" name="discussTime"  value="<%=countTime.currentlyTime() %>" size="30" readonly="readonly" onclick="alert('此文本框已设为只读，管理员不能修改')">
