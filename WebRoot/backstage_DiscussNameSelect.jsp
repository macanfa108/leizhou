...
<div class="box-body">
     ...
     <%for(int i=0;i<list.size();i++){ 
         ...
         <tr  bgcolor="#009393">
              ...
              <td title="如果想察看详细内容，单击相应的修改链接"bgcolor="#009393"><div align="center"><%=discussForm.getDiscussTime()%></div></td>
              <td><div align="center" bgcolor="#009393"><a href="Front1_gonggaozhidengxs.jsp?id=<%=discussForm.getDiscussId()%>" title="可以查看相应的公告内容">置顶</a>&nbsp;&nbsp;<a href="javascript:deleteForm('<%=discussForm.getDiscussId()%>')">删除</a></div></td>
            </tr>
			<%} %>
