...
<%
	...
	if (list.size() == 0) {
		out.print("<script language=javascript>alert('精品类型还没有添加，请添加！');window.location.href='backstage_ThingAdd.jsp';</script>");
	}
%>
<body>
		...
		<div class="mainbar">
			...
			<form align="center" class="form-search s-widget myform" name="form"
				...
				<div class="input-append">
					精品名字&nbsp;&nbsp; <input type="text" id="inputPassword"
						placeholder="请输入精品名字" style="height:31px;width:500px"
					...
					<img src="<%=(String) request.getParameter("photoURL")%>"
						...
						<br>
					精品描述&nbsp;&nbsp;
					<textarea id="inputPassword" placeholder="请输入精品描述" cols="80"
