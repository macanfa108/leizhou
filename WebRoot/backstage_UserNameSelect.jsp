...
<%
	...
	String s = (String) request.getParameter("selectName");
	int Page = 1;
	List list = null;
	if (str == null) {
		list = consumerDao.getConsumerList(s, "1");
...
--%>
				<div class="box-body">
					<form align="right" class="form-search s-widget" name="form"
						...
						<span style="width:100px;height:50px;bgcolor:yellow;float:left;"
							font-size:16pt><h1>用户列表</h1></span>
