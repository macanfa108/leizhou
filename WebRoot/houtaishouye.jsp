...
<div class="content">
  ...
  <div class="mainbar">
            ...
            <form align="right" class="form-search s-widget">
              <div class="input-append">
                                          请输入原密码
               <input type="text"  id="inputPassword" placeholder="原密码" style="height:31px;width:200px" font-size:16px>
                                            请输入新密码
               <input type="text"  id="inputPassword" placeholder="新密码" style="height:31px;width:200px" font-size:16px>
