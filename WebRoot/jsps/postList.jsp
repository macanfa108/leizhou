				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li  class="active"><a href="<%=path %>/jsps/postList.jsp"><span class="glyphicon glyphicon-list-alt"></span>  帖子列表</a></li>
				...
				<div class="row">
					...
					<div class="col-md-8 main-content">
						<article class="post tag-about-ghost tag-ghost-in-depth tag-zhu-shou-han-shu">
							<div class="post-head">
								<h2 class="post-title"><a href="#">帖子列表</a></h2>
							</div>
							<div class="post-meta">
								<span class="author">
									建议游玩：<a href="#">2天</a>
